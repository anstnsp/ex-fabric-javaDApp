      ...
      public Builder networkConfig(final InputStream config) throws IOException {
          try (InputStream bufferedStream = copyToMemory(config)) {
              try {
                  ...
                  Properties peer0Props = ccp.getPeerProperties("peer0.orgdoro.com");
                  peer0Props.put("grpc.NettyChannelBuilderOption.maxInboundMessageSize", 20000000); //grpc size: 20mb 
                  ccp.setPeerProperties("peer0.orgdoro.com", peer0Props);
                //   Properties peer1Props = ccp.getPeerProperties("peer1.orgdoro.com");
                //   peer1Props.put("grpc.NettyChannelBuilderOption.maxInboundMessageSize", 20000000);
                //   ccp.setPeerProperties("peer1.orgdoro.com", peer1Props);
              }
